        ...
        return AlertDialog(
          ...
          content: Column(
            ...
            children: [
              ...
              // 설명 텍스트
              Text(
                lang('다른 유저와 승리시 +2, 패배시 -1이 적용됩니다'),
                style: TextStyle(
                  fontSize: 14,
  ...
  String lang(String textKey) {
    final localizedTexts = {
      'KOR': {
        ...
        '닉네임': '닉네임',
        '연승': '연승',
        '다른 유저와 승리시 +2, 패배시 -1이 적용됩니다': '다른 유저와 승리시 +2, 패배시 -1이 적용됩니다',
        '랭크 정보': '랭크 정보',
        '내 정보': '내 정보',
        '고양이': '고양이',
        '크리스마스': '크리스마스',
      ...
      'ENG': {
        ...
        '닉네임': 'Nickname',
        '연승': 'Winning Streak',
        '다른 유저와 승리시 +2, 패배시 -1이 적용됩니다': '+2 for Win, -1 for Loss',
        '랭크 정보': 'Rank Info',
        '내 정보': 'My Info',
        '고양이': 'Cat',
        '크리스마스': 'Christmas',
      ...
      'ARA': {
        ...
        '닉네임': 'الاسم المستعار',
        '연승': 'سلسلة الانتصارات',
        '다른 유저와 승리시 +2, 패배시 -1이 적용됩니다': '+2 للفوز، -1 للخسارة',
      ...
      'CHN': {
        ...
        '닉네임': '昵称',
        '연승': '连胜',
        '다른 유저와 승리시 +2, 패배시 -1이 적용됩니다': '胜+2, 败-1',
        '랭크 정보': '排名信息',
        '내 정보': '我的信息',
        '고양이': '猫咪',
        '크리스마스': '圣诞节',
      ...
      'JPN': {
        ...
        '닉네임': 'ニックネーム',
        '연승': '連勝',
        '다른 유저와 승리시 +2, 패배시 -1이 적용됩니다': '勝利で+2、敗北で-1',
        '랭크 정보': 'ランク情報',
        '내 정보': '私の情報',
        '고양이': '猫',
        '크리스마스': 'クリスマス',
      ...
      'FRA': {
        ...
        '다른 유저와 승리시 +2, 패배시 -1이 적용됩니다': 'Victoire: +2, Défaite: -1',
        '랭크 정보': 'Infos de rang',
        '내 정보': 'Mes infos',
        '고양이': 'Chat',
        '크리스마스': 'Noël',
      ...
      'GER': {
        ...
        '닉네임': 'Spitzname',
        '연승': 'Siegessträhne',
        '다른 유저와 승리시 +2, 패배시 -1이 적용됩니다': 'Sieg: +2, Niederlage: -1',
        '랭크 정보': 'Ranginfo',
        '내 정보': 'Meine Infos',
        '고양이': 'Katze',
        '크리스마스': 'Weihnachten',
      ...
      'ESP': {
        ...
        '닉네임': 'Apodo',
        '연승': 'Racha ganadora',
        '다른 유저와 승리시 +2, 패배시 -1이 적용됩니다': 'Victoria: +2, Derrota: -1',
      ...
      'RUS': {
        ...
        '닉네임': 'Никнейм',
        '연승': 'Серия побед',
        '다른 유저와 승리시 +2, 패배시 -1이 적용됩니다': 'Победа: +2, Поражение: -1',
